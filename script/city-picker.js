        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="' +
                    this.getWidthStyle() + 'width:75%;height:1.6rem;line-height:1.45rem;padding-left:0;font-size:0.45rem;color:#666;">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"style="' +
                    this.getWidthStyle() + 'width:90%;display: inline-block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"></span><div class="arrow"></div>' + '</span>',

                dropdown = '<div class="city-picker-dropdown" style="left:0;top:1.6rem;right:0px;width:85%' +
